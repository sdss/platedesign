...
;; bottom row
gfiber[0:2].yreach= -outercols_mm
gfiber[0:2].xreach= rows_mm[0]

;; second row
gfiber[3:6].yreach= -innercols_mm
gfiber[3:6].xreach= rows_mm[1]

;; third row
gfiber[7:10].yreach= innercols_mm
gfiber[7:10].xreach= rows_mm[2]

;; top row
gfiber[11:13].yreach= outercols_mm
gfiber[11:13].xreach= rows_mm[3]

;; set all reaches the same
gfiber[0:13].rreach = small_rreach_mm

;; set the large guide fibers
gfiber[14].yreach= -22.86
gfiber[14].xreach= rows_mm[1]
gfiber[14].rreach= large_rreach_mm
gfiber[15].yreach= 22.86
gfiber[15].xreach= rows_mm[2]
...
gfiber[14].xprefer= rows_mm[1]*0.5
gfiber[15].xprefer= rows_mm[2]*0.5
