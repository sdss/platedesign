...
bossblocks0 = [1, 4, 5, 7, 9, 11]
bossblocks1 = [0, 1, 4, 6, 8, 10, 11]
bossblocks2 = [2, 4, 6, 8, 11, 13]
bossblocks3 = [0, 2, 4, 6, 8, 10]
...
outfile= getenv('PLATEDESIGN_DIR')+ $
         '/data/boss/fiberBlocksBOSSwAPOGEE_v2.par'
