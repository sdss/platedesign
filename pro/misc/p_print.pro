...
; CALLING SEQUENCE:
;   p_print, filename= [, tiny=, axis_char_scale=, pold=, xold=, $
...
;                      (for input into p_end_print)
; REVISION HISTORY:
;   26-Feb-2003  Written by M. Blanton, NYU
;-  
;------------------------------------------------------------------------------
pro p_print,filename=filename,axis_char_scale=axis_char_scale, $
            tiny=tiny,pold=pold,xold=xold,yold=yold,colorname=colorname, $
            xsize=xsize,ysize=ysize

common com_p_print, bangp, bangx, bangy
