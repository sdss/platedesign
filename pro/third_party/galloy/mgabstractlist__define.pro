...
;          changed)
;-
pro mgabstractlist::getProperty, version=version
...
;-
pro mgabstractlist::add, elements, position=position
    compile_opt strictarr
...
;-
function mgabstractlist::get, all=all, position=position, count=count, isa=isa
    compile_opt strictarr
...
;-
function mgabstractlist::isContained, elements, position=position
    compile_opt strictarr
...
;-
pro mgabstractlist::move, source, destination
    compile_opt strictarr
...
pro mgabstractlist::remove, elements, position=position, all=all
    compile_opt strictarr
...
;-
function mgabstractlist::iterator
    compile_opt strictarr
...
;-
pro mgabstractlist__define
    compile_opt strictarr

    define = { mgabstractlist, version : 0L }
end
