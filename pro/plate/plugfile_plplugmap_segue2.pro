;+
; NAME:
;   plugfile_plplugmap_segue2
; PURPOSE:
;   Create a plug file in the style of plPlugMapP files from SEGUE-2
; CALLING SEQUENCE:
;   plugfile_plplugmap_segue2, hdr, holes
; INPUTS:
...
if(nsdssother gt 0) then begin
    plug[isdssother].mag= 22.5-2.5*alog10(holes[isdssother].fiberflux > 0.1)
endif
