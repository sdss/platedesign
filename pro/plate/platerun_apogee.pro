...
;   platerun_apogee
; PURPOSE:
;   Prepare files and run the low-level plate routines for APOGEE 
; CALLING SEQUENCE:
;   platerun_apogee, platerun, plateid
; INPUTS:
...
;   10-Jun-2008  MRB, NYU
;-
pro platerun_apogee, platerun, plateid, nolines=nolines
...
;; make counterbores
for i=0L, n_elements(plateid)-1L do $
   plate_counterbore, platerun, plateid[i]
