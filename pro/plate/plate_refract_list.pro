...
;
; DESCRIPTION:
;   PLATE_REFRACT_LIST can calculate both apparent altitude from observed altitude and 
;   vice-versa.
;
; CALLING SEQUENCE:
;   new_alt  = PLATE_REFRACT_LIST(old_alt, [ ALTITUDE= , PRESSURE= , $
...
function plate_refract_list, a, altitude=altitude, pressure=pressure,  $
